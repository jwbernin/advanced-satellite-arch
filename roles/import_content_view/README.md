# Red Hat Satellite - Import Content Views

Ansible modules for interacting with the Satellite API importing content views versions.
...
|`satellite_import_content_view_version`|`true`|yes|boolean|Importing Content View Version||
...
|`satellite_import_content_view_metadata_file`|"`{{ satellite_import_path }}/metadata.json`"|yes|string|Metadata file for import|/var/lib/pulp/imports/metedata.json|
...
|`satellite_import_content_view_name`|""|yes|string|Content view name|satellite6|
|`satellite_import_content_view_version_number`|""|yes|string|Content view version number|1.0|
...
- name: Import Content View
  ...
  tasks:
    - name: INCLUDE_ROLE | import_content_views
      ansible.builtin.include_role:
        name: import_content_view
...
```
...
#### Modules
- [redhat.satellite.content_import_version](https://console.redhat.com/ansible/automation-hub/repo/published/redhat/satellite/content/module/content_import_version/)
